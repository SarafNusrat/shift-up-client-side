            ...
            <div className="pt-8 mx-auto h-auto card w-96 mb-8 bg-base-100 shadow-xl">
                <div className="max-w-xs mx-auto overflow-hidden bg-white dark:bg-gray-800">
                    <div className="px-4 py-2">
                        ...
                        <span className='text-gray-600 text-sm font-semibold'>Min Order Quantity: {min_order_quantity}</span>
                    </div>
                    ...
                    <img className="object-cover w-full h-48 mt-2" src={img} alt="car part"></img>
                        ...
                        <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                            ...
                            <button onClick={() => showPartDetail(_id)} className="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-200 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">PURCHASE</button>
                        </div>
                </div>
            </div>
        </div>
